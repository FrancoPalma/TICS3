...
usuarioController.postEditarPrivilegios = (req, res) => {
	...
	pool.query('INSERT INTO privilegios(gestion_usuario, gestion_ficha, gestion_priv, gestion_evaluacion, gestion_infante) VALUES ($1,$2,$3,$4,$5) WHERE privilegios.rut_usuario = $6', [gestion_usuario, gestion_ficha, gestion_priv, gestion_evaluacion, gestion_infante, rut_usuario], (err) => {
		if(err){res.sendStatus(404)}
